...
class AtaxxNNet():
    def __init__(self, game, args):
        ...
        s_fc1 = Dropout(args.dropout)(Activation('relu')(BatchNormalization(axis=1)(Dense(1024, use_bias=False)(h_conv2_flat))))  # batch_size x 1024
